...
function Home() {
    ...
    const combatActionTiles = [
        ...
        {icon: ICONS.disengageIcon, title: "Disengage", shortDescription: "Swiftly Escape Attack", longDescription: "Once disengaged, for the rest of your turn, you do not provoke opportunity attacks."},
    ...
    const conditionTiles = [
        ...
        {icon: ICONS.deafenedIcon, title: "Deafened", shortDescription: "You cannot hear", longDescription: "Automatically fail hearing-dependent checks."},
